// Tanto sanity — range checks and Fermi estimates
// Adapted for CID integration

/// Result of a sanity check (value against physical range)
#[derive(Debug, Clone)]
...
/// Result of a Fermi order-of-magnitude estimate
#[derive(Debug, Clone)]
...
/// Check a value against known physical ranges
/// Format: "check 600 as speed_mph"
...
/// Fermi order-of-magnitude estimate
...
/// List available sanity check categories
